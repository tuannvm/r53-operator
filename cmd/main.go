...
import (
	...
	"github.com/tuannvm/r53-operator/operator"
)
...
func (m *Main) getKubernetesClients() (route53k8scli.Interface, crd.Interface, kubernetes.Interface, error) {
	var err error
	var cfg *rest.Config
	...
	ptCli, err := route53k8scli.NewForConfig(cfg)
	if err != nil {
		return nil, nil, nil, err
	}

...
import (
	...
	"github.com/tuannvm/r53-operator/client/k8s/clientset/versioned/scheme"
...
// Route53V1alpha1Client is used to interact with features provided by the route53.tuannvm.com group.
type Route53V1alpha1Client struct {
	restClient rest.Interface
}

func (c *Route53V1alpha1Client) Route53s() Route53Interface {
	return newRoute53s(c)
}
